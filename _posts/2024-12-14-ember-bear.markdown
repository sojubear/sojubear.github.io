...
<img src="{{ site.baseurl }}\assets\img\posts\ember.webp" alt="Description of the image" class="center-image">

# Unit 29155: A Key Player in the GRU's Cyber Operations
...
Unit 29155 is assessed to be part of the GRU’s **161st Special Purpose Specialist Training Centre**. Although thought to have been established in 2008, their existence only became public in 2019. They are thought to focus heavily on activities such as assassination and attempts at destabilizing European countries. Some notable events include:

- **2015 Poisoning of Bulgarian Arms Factory Owner**: An attempt to poison Bulgarian arms dealer Emiliyan Gebrev using a type of poison similar to Novichok.
- **2018 Poisoning of Former GRU Officer**: Another attempt to poison former Russian spy and British double agent Sergei Skripal using similar techniques.
...
### Translated Defacement Message
*Credit goes to Don_Standeford*
...
The integration of a cyber unit in Unit 29155 raises an important question: What exactly is their role compared to the other GRU hacking groups? Let's explore and draw similarities and differences between these units, as at a high level, there seems to be an overlap in what Ember Bear does.

### Fancy Bear

The most well-known hacking attempts of Fancy Bear include:
- The **2015 German Bundestag** hack
- The **2016 Democratic National Committee** hack
- The **2016 World Anti-Doping Agency** hack

These incidents are similar in a way that hacking these targets does not cause any "physical damage" and it’s mostly for intelligence collection and advancing Russia’s geopolitical agenda.

### Sandworm

Sandworm is Russia’s primary cyber sabotage unit. They focus on purely causing physical disruption to their adversaries. Notable incidents include:
- The **2014 and 2015 attack on Ukraine’s power grid**
- **NotPetya** in 2017
- The disruption of the **2018 Pyeongchang Winter Olympics**

### Ember Bear

Ember Bear, on the other hand, has been reported to target critical infrastructure, including government, financial, transportation services, energy, and healthcare sectors—systems that could cause actual physical harm and disruption. The only physical disruption so far being the **WhisperGate** attack against Ukraine.
...
1. **Ember Bear as a Training Unit**: Ember Bear could be a training unit. Their focus on both cyber espionage and cyber sabotage would allow operators to gain experience on both sides before transitioning to more advanced counterparts.
2. **Ember Bear’s Purpose in Supporting the GRU in the Fight Against Ukraine**: Ember Bear might be more aligned with Sandworm, with their current area of operations in Ukraine. They might be establishing themselves as the cyber espionage arm of the GRU in the war against Ukraine, while Sandworm focuses on cyber sabotage.
3. **Ember Bear as the Global Sandworm**: With Ember Bear initially targeting global critical infrastructure before being redirected to the war effort, they might actually be setting themselves up to conduct Sandworm-style attacks on a global scale.

## Conclusion

It takes a lot of planning, resources, and explicit direction to set up a new military unit. For the GRU to integrate cyber capabilities into Unit 29155 shows that the Russian leadership has deemed their previous cyber operations highly successful, warranting the creation of a new unit. Or perhaps Unit 29155 serves a different purpose compared to its big brothers Fancy Bear and Sandworm. Nonetheless, this event shows that Russia is heavily invested in using cyber operations to achieve its goals.
